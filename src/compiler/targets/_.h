...
typedef struct Target {
    ...
    void (*_var_begin)(struct Target *target, Interpreter *interpreter, const compile_file *file, TypeRef T);
    void (*_var_end)(struct Target *target, Interpreter *interpreter, const compile_file *file, TypeRef T);
